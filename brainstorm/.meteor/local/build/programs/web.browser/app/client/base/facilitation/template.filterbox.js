(function(){
Template.__checkName("filterbox");
Template["filterbox"] = new Template("Template.filterbox", (function() {
  var view = this;
...
Template.__checkName("FilterBoxIdeaItem");
Template["FilterBoxIdeaItem"] = new Template("Template.FilterBoxIdeaItem", (function() {
  var view = this;
  return HTML.LI({
    id: function() {
...
Template.__checkName("activefilters");
Template["activefilters"] = new Template("Template.activefilters", (function() {
  var view = this;
  return HTML.DIV({
