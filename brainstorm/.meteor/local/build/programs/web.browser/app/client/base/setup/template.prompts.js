(function(){
Template.__checkName("namebox");
Template["namebox"] = new Template("Template.namebox", (function() {
  var view = this;
  return HTML.DIV({
...
Template.__checkName("Brainstorm");
Template["Brainstorm"] = new Template("Template.Brainstorm", (function() {
  var view = this;
  return HTML.DIV({
    id: function() {
...
Template.__checkName("PromptPage");
Template["PromptPage"] = new Template("Template.PromptPage", (function() {
  var view = this;
