(function(){
Template.__checkName("ClusterIdeaItem");
Template["ClusterIdeaItem"] = new Template("Template.ClusterIdeaItem", (function() {
  var view = this;
  return HTML.LI({
    id: function() {
...
Template.__checkName("IdeaList");
Template["IdeaList"] = new Template("Template.IdeaList", (function() {
  var view = this;
...
Template.__checkName("ClusterList");
Template["ClusterList"] = new Template("Template.ClusterList", (function() {
  var view = this;
  return HTML.DIV({
    "class": "cluster-list"
...
Template.__checkName("clusterarea");
Template["clusterarea"] = new Template("Template.clusterarea", (function() {
  var view = this;
...
Template.__checkName("cluster");
Template["cluster"] = new Template("Template.cluster", (function() {
  var view = this;
  return HTML.DIV({
    "class": "cluster",
    id: function() {
...
Template.__checkName("Clustering");
Template["Clustering"] = new Template("Template.Clustering", (function() {
  var view = this;
  return [ HTML.DIV({
