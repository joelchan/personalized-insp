(function(){
Template.__define__("SurveyPage", (function() {
  var view = this;
  return HTML.DIV({
    "class": "container"
...
Template.__define__("IdeationSurvey", (function() {
  var view = this;
...
Template.__define__("SynthesisSurvey", (function() {
  var view = this;
...
Template.__define__("FacilitatorSurvey", (function() {
  var view = this;
