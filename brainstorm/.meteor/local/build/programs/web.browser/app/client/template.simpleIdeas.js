(function(){
Template.__define__("simpleIdea", (function() {
  var view = this;
  return HTML.DIV({
    "class": "list-item",
    draggable: "true"
...
Template.__define__("NotificationDrawer", (function() {
  var view = this;
...
Template.__define__("NotifyItem", (function() {
  var view = this;
  return HTML.DIV({
    "class": function() {
...
Template.__define__("sentexamples", (function() {
  var view = this;
...
Template.__define__("Priming", (function() {
  var view = this;
...
Template.__define__("sentprompt", (function() {
  var view = this;
...
Template.__define__("senttheme", (function() {
  var view = this;
...
Template.__define__("Directions", (function() {
  var view = this;
...
Template.__define__("Prompt", (function() {
  var view = this;
  return HTML.DIV({
    "class": "prompt-box"
  }, HTML.Raw('\n    <!-- <p class="heading"> -->\n    '), HTML.P("\n      ", Blaze.View(function() {
...
Template.__define__("SubmitIdeas", (function() {
  var view = this;
  return HTML.DIV({
    "class": "row"
  }, "\n    ", HTML.DIV({
...
Template.__define__("IdeationPage", (function() {
  var view = this;
  return HTML.DIV({
    "class": "row"
