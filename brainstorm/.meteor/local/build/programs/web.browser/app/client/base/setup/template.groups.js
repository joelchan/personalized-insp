(function(){
Template.__checkName("RoleMembers");
Template["RoleMembers"] = new Template("Template.RoleMembers", (function() {
  var view = this;
  return HTML.LI({
...
Template.__checkName("GroupPanel");
Template["GroupPanel"] = new Template("Template.GroupPanel", (function() {
  var view = this;
  return HTML.DIV({
    id: function() {
...
Template.__checkName("RoleSize");
Template["RoleSize"] = new Template("Template.RoleSize", (function() {
  var view = this;
