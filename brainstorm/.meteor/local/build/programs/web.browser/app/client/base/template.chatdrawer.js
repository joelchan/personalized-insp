(function(){
Template.__checkName("chatdrawer");
Template["chatdrawer"] = new Template("Template.chatdrawer", (function() {
  var view = this;
...
Template.__checkName("ChatMessages");
Template["ChatMessages"] = new Template("Template.ChatMessages", (function() {
  var view = this;
  return HTML.DIV({
    "class": "messageview"
  }, "\n	", Blaze.Each(function() {
